        ...
        <div class="row content">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            ...
            <ul>
              ...
              <li><i class="ri-check-double-line"></i>Service Provider Network</li>
              <li><i class="ri-check-double-line"></i>Customized Care Plans</li>
              <li><i class="ri-check-double-line"></i>Booking and Scheduling</li>
              <li><i class="ri-check-double-line"></i>Quality Assurance</li>
              <li><i class="ri-check-double-line"></i>Ongoing Support and Adjustments</li>
    ...
    <section id="skills" class="skills">
      <div class="container">
        ...
        <div class="row skills-content">
          <div class="col-lg-6">
            <div class="progress">
              <span class="skill">Service Provider Quality <i class="val">100%</i></span>
            ...
            <div class="progress">
              <span class="skill">Personalized Care Plans <i class="val">90%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">Reliability and Timeliness <i class="val">75%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">Safety and Security <i class="val">55%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                </div>
              </div>
            ...
            <div class="progress">
              <span class="skill">Compliance and Accreditation <i class="val">55%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">Ease of Use <i class="val">80%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">Communication and Transparency <i class="val">90%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">
                </div>
              </div>
            ...
            <div class="progress">
              <span class="skill">Flexibility and Adaptability <i class="val">55%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">Customer Satisfaction <i class="val">55%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">
                </div>
              </div>
            ...
            <div class="progress">
              <span class="skill">Affordability and Value<i class="val">55%</i></span>
              <div class="progress-bar-wrap">
